...
class Update extends BaseObject
{
    ...
    public function getMessage(): Collection
    {
        ...
        if ($message->get('message_id') && $this->telegram){
    ...
    {
        return $this->getChat()->get('id');
    }

    public function getFromId(): ?int
    {
        return $this->getFrom()->get('id');
    }
     ...
     * 
     */
    public function getCallbackQueryData() : CallbackQueryData
    {
        return new CallbackQueryData($this->getCallbackQuery());
    }
